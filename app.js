...
function dataPlan(planLimit, day, usage){
    ...
    if(actualDailyUsage > dailyUsagePlan){
        console.log(`You are EXCEEDING your average daily use of ${dailyUsagePlan} 
        by ${actualDailyUsage - dailyUsagePlan} GB/day.
        If you continue with this high usage, you'll exceed your data plan by ${dataExceededBy}. 
        To stay below your data plan, use no more than ${newUsagePlan} GB/day`);
    }
